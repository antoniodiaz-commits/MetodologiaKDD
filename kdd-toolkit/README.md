# KDD Toolkit — Claude Code Plugin

Knowledge-Driven Development toolkit for delivery teams. Manage specs, analyze knowledge graphs, activate context for AI agents, and guide spec creation — all from Claude Code.
...
git clone <repo-url> ~/.claude/plugins/kdd-toolkit

# Install CLI dependencies
cd ~/.claude/plugins/kdd-toolkit/cli && npm install
```
...
```bash
# Add to your project
git submodule add <repo-url> .kdd-toolkit

# Install CLI dependencies
cd .kdd-toolkit/cli && npm install
```
